...
{
    public class StockDeclarationDetailMap : EntityTypeConfiguration<StockDeclarationDetail>
    {
        public StockDeclarationDetailMap()
        {
            // Primary Key
            ...
            this.ToTable("StockDeclarationDetails");
            ...
            // Relationships
            this.HasRequired(t => t.StockDeclaration)
                .WithMany(t => t.StockDeclarationDetails)
                .HasForeignKey(d => d.StockDeclarationFKID);
